namespace Headless.UnitTests
{
    ...
    /// <summary>
    ///     The <see cref="InvalidHtmlElementMatchExceptionTests" />
    ///     class tests the <see cref="InvalidHtmlElementMatchException" /> class.
    /// </summary>
    [TestClass]
    public class InvalidHtmlElementMatchExceptionTests
    {
        /// <summary>
        ...
        public void CanBeCreatedWithMessageAndExceptionTest()
        {
            ...
            var target = new InvalidHtmlElementMatchException(exceptionMessage, innerException);
        ...
        public void CanBeSerializedAndDeserializedTest()
        {
            ...
            using (var ms = new MemoryStream())
            {
                ...
                var outputException = formatter.Deserialize(ms) as InvalidHtmlElementMatchException;
        ...
        {
            var target = new InvalidHtmlElementMatchException();
        ...
        public void MessageReturnsValueWhenCreatedWithMessageTest()
        {
            ...
            var target = new InvalidHtmlElementMatchException(exceptionMessage);
